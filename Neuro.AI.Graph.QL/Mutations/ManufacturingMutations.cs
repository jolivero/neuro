...
namespace Neuro.AI.Graph.QL.Mutations
{
    public class ManufacturingMutations
    {
        ...
        public async Task<MessageResponse> repo_create_machine_report(MachineRepository repository, MachineReportDto machineReportDto)
        {
            return await repository.Create_machine_report(machineReportDto);
        }

        public async Task<MessageResponse> repo_update_machine_report(MachineRepository repository, int reportId, MachineReportDto machineReportDto)
        {
